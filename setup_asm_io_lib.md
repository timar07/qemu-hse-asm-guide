...
Создаем свою папку чтобы не захламлять системную (может потребовать пароль)
```
...
Создаем 'ссылку' на скрипт (может потребовать пароль)
```
...
Создаем файлик `.asm` **НЕ В ЭТОЙ ПАПКЕ**
